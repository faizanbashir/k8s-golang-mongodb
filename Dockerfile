...
LABEL maintainer="faizanbashir" \
  ...
  org.opencontainers.image.url="https://github.com/faizanbashir/k8s-golang-nginx-mongodb" \
  org.opencontainers.image.source="https://github.com/faizanbashir/k8s-golang-nginx-mongodb" \
  org.opencontainers.image.version=$VERSION \
  org.opencontainers.image.revision=$REVISION \
  org.opencontainers.image.vendor="faizanbashir" \
  org.opencontainers.image.title="k8s-golang-nginx-mongodb" \
